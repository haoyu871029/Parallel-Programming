...
void my_nn(float *training_images_flat, int num_images,
    ...
    LinearLayer(training_images_flat, 
                layer1_matrix, layer1_bias, layer1_output,
                num_images, LAYER0, LAYER1);

    Sigmoid(layer1_output, 
            num_images, LAYER1);
    ...
    LinearLayer(layer1_output, 
                layer2_matrix, layer2_bias, layer2_output,
                num_images, LAYER1, LAYER2);

    Argmax(layer2_output, 
            result, num_images, LAYER2);
...
//(copy this code to lab5.cpp)
//load module (NVIDIA HPC SDK): module load nvhpc
//compile in hades01: make
//execute in hades01: srun --gres=gpu:1 ./lab5
//judge in hades01: lab5-judge